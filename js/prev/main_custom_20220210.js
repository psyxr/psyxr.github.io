...
$(document).ready(function() {
    ...
    const makeSliderBtnCont = function(basicObj) {
        ...
        btnObj.makeLinkedBoxShadowBtns = function() {
            ...
            const makeSliderBtn = function(basicObj) {
                ...
                0% {
                    ...
                    box-shadow:
                        -15px 15px 30px rgba(141, 141, 141, 0.2),
                        15px -15px 30px rgba(141, 141, 141, 0.2),
                        -15px -15px 30px rgba(173, 173, 173, 0.9),
                        15px 15px 38px rgba(141, 141, 141, 0.9),
                        inset 1px 1px 2px rgba(173, 173, 173, 0.3),
                        inset -1px -1px 2px rgba(141, 141, 141, 0.5);
                }
                ...
                100% {
                    ...
                    box-shadow:
                        -15px 15px 30px rgba(141, 141, 141, 0.2),
                        15px -15px 30px rgba(141, 141, 141, 0.2),
                        -15px -15px 30px rgba(173, 173, 173, 0.8),
                        15px 15px 38px rgba(141, 141, 141, 0.8),
                        inset 1px 1px 2px rgba(173, 173, 173, 0.3),
                        inset -1px -1px 2px rgba(141, 141, 141, 0.5),

                        1px 1px 2px rgba(173, 173, 173, 0.3),
                        -1px -1px 2px rgba(141, 141, 141, 0.5),
                        inset -8px 8px 16px rgba(141, 141, 141, 0.2),
                        inset 8px -8px 16px rgba(141, 141, 141, 0.2),
                        inset -8px -8px 16px rgba(173, 173, 173, 0.9),
                        inset 8px 8px 20px rgba(141, 141, 141, 0.9);
                }
                ...
                50% {
                    ...
                    box-shadow:
                        ...
                        1px 1px 2px rgba(173, 173, 173, 0.3),
                        -1px -1px 2px rgba(141, 141, 141, 0.5),
                        inset -10px 10px 20px rgba(141, 141, 141, 0.2),
                        inset 10px -10px 20px rgba(141, 141, 141, 0.2),
                        inset -10px -10px 20px rgba(173, 173, 173, 0.9),
                        inset 10px 10px 25px rgba(141, 141, 141, 0.9);
                }
    ...
    const sliderBtnCont = makeSliderBtnCont(makeCommonAnimatedBtnObj());

    makeAnimatedBtn(sliderBtnCont);

    $(".lm_inner_slider_arrow").click(function(){
        var clickedBtnId = $(this).attr("id");
        let innerSlider = function () {
            let sliderObj = makeCommonSliderObj();
            sliderObj.slidingElementsObjects = [
                {
                    selector: ".lm_screen_slide_group_active > .lm_screen_inner_slide_active",
